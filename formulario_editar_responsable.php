...
$ans = mysqli_query($link, "select responsable from t_responsable where id_responsable='$xeditar'");   
  ...
  <div id="menu">
	<barra>
		...
		<div class="botonera" id="uno">
			<a href="formulario_crear_responsable.php"><img class="icon" src="atras.png"></a>
...
<fieldset style="width:600px; background-color:White">
 <legend>Formulario para modificar un ente responsable</legend>
<form action="actualizar_responsable.php" method="POST">
<input type="hidden" name="id_responsable" value="<?php echo $xeditar; ?>" />
<label>Ente responsable:</label><input type="text" name="responsable" value="<?php echo $responsable?>"><br>
