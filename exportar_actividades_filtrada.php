...
$filtroregional = $_GET['regional'];
$fecha1 = $_GET['fecha1'];
$fecha2 = $_GET['fecha2'];
$filtropar = $_GET['participante'];
     ...
     $consultaSQL = "SELECT t_matrix.id_fecha as id_fecha  
                    FROM t_matrix, regional, t_responsable
                      WHERE id_fecha 
                          ...
                          AND t_matrix.id_regional = ".$filtroregional." AND t_matrix.participantes LIKE '%$filtropar%' 
